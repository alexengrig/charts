...
| `server.image.tag`                                  | Spring Cloud Dataflow image tag (immutable tags are recommended)                                                                           | `2.10.2-debian-11-r6`                                |
...
| `server.composedTaskRunner.image.tag`               | Spring Cloud Dataflow Composed Task Runner image tag (immutable tags are recommended)                                                      | `2.10.2-debian-11-r5`                                |
...
| `skipper.image.tag`                          | Spring Cloud Skipper image tag (immutable tags are recommended)                                                      | `2.9.2-debian-11-r5`           |
...
| `metrics.image.tag`                          | Prometheus Rsocket Proxy image tag (immutable tags are recommended)                                                        | `1.5.0-debian-11-r74`              |
...
| `waitForBackends.image.tag`          | Init container wait-for-backend image tag                                                                                       | `1.25.8-debian-11-r3` |
